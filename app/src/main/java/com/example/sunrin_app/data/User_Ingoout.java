...
public class User_Ingoout {
    ...
    public User_Ingoout(){}
    public User_Ingoout(String Uid, String email){
        this.Uid = Uid;
        this.email = email;
    }
    public User_Ingoout(String Uid, String email, String intro, String name, String type, String gender, String location){
        this.Uid = Uid;
        this.email = email;
    }
